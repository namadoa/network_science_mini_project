...
if __name__=='__main__':
    ...
    hashtag_table = load_table(in_fb, 'hashtags_final_part_1', columns=5, ts_col=2)
    mention_table = load_table(in_fb, 'mentions_final_part_1', columns=5, ts_col=2)
    reply_table   = load_table(in_fb, 'replies_final_part_1',  columns=6, ts_col=2)

    tables   = [hashtag_table, mention_table, reply_table]
